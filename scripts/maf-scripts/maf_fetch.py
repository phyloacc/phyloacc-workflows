...
## DO MAF FILES CONTAIN EVERY POSITION OF THE REFERENCE SEQ?
...
bed_file = "test-chr22-subset.bed";
...
if bed_sorted:
    ...
    for line in open(bed_file):
        ...
        if test and not seqTest(ref_genome_fasta, seqs["Homo_sapiens"]["chr22"][0]['seq'], chrom, region_start, region_end, debug=True):
            sys.exit(1);

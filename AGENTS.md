...
- This directory contains a project for comparative genomic workflow development, centered on preparing the inputs for PhyloAcc but some parts having broader applicability.
- The current project directory is `/n/holylfs05/LABS/informatics/Lab/projects/gwct/phyloacc/phyloacc-workflows/`, referred to as `<project directory>` in this file.

...
print(f"Found {len(clusters_info)} clusters (excluding noise)")
print(f"Clustered {sum(c['count'] for c in clusters_info.values())} sites out of {len(conserved_sites)} total")
